...
void _BehaviorServer::_bind_methods() {
	...
	ClassDB::bind_method(D_METHOD("blackboard_set_parent", "rid", "parent"), &_BehaviorServer::blackboard_set_parent);
	ClassDB::bind_method(D_METHOD("blackboard_get_parent", "rid"), &_BehaviorServer::blackboard_get_parent);
	ClassDB::bind_method(D_METHOD("blackboard_is_ancestor", "rid", "candidate"), &_BehaviorServer::blackboard_is_ancestor);
	...
	ClassDB::bind_method(D_METHOD("blackboard_set_int", "rid", "name", "value"), &_BehaviorServer::blackboard_set_entry<int64_t>);
	ClassDB::bind_method(D_METHOD("blackboard_set_float", "rid", "name", "value"), &_BehaviorServer::blackboard_set_entry<real_t>);
	ClassDB::bind_method(D_METHOD("blackboard_set_string", "rid", "name", "value"), &_BehaviorServer::blackboard_set_entry<String>);
	ClassDB::bind_method(D_METHOD("blackboard_set_vector2", "rid", "name", "value"), &_BehaviorServer::blackboard_set_entry<Vector2>);
	ClassDB::bind_method(D_METHOD("blackboard_set_vector2i", "rid", "name", "value"), &_BehaviorServer::blackboard_set_entry<Vector2i>);
	ClassDB::bind_method(D_METHOD("blackboard_set_rect2", "rid", "name", "value"), &_BehaviorServer::blackboard_set_entry<Rect2>);
	ClassDB::bind_method(D_METHOD("blackboard_set_rect2i", "rid", "name", "value"), &_BehaviorServer::blackboard_set_entry<Rect2i>);
	ClassDB::bind_method(D_METHOD("blackboard_set_vector3", "rid", "name", "value"), &_BehaviorServer::blackboard_set_entry<Vector3>);
	ClassDB::bind_method(D_METHOD("blackboard_set_vector3i", "rid", "name", "value"), &_BehaviorServer::blackboard_set_entry<Vector3i>);
	ClassDB::bind_method(D_METHOD("blackboard_set_transform2d", "rid", "name", "value"), &_BehaviorServer::blackboard_set_entry<Transform2D>);
	ClassDB::bind_method(D_METHOD("blackboard_set_vector4", "rid", "name", "value"), &_BehaviorServer::blackboard_set_entry<Vector4>);
	ClassDB::bind_method(D_METHOD("blackboard_set_vector4i", "rid", "name", "value"), &_BehaviorServer::blackboard_set_entry<Vector4i>);
	ClassDB::bind_method(D_METHOD("blackboard_set_plane", "rid", "name", "value"), &_BehaviorServer::blackboard_set_entry<Plane>);
	ClassDB::bind_method(D_METHOD("blackboard_set_quaternion", "rid", "name", "value"), &_BehaviorServer::blackboard_set_entry<Quaternion>);
	ClassDB::bind_method(D_METHOD("blackboard_set_aabb", "rid", "name", "value"), &_BehaviorServer::blackboard_set_entry<AABB>);
	ClassDB::bind_method(D_METHOD("blackboard_set_basis", "rid", "name", "value"), &_BehaviorServer::blackboard_set_entry<Basis>);
	ClassDB::bind_method(D_METHOD("blackboard_set_transform3d", "rid", "name", "value"), &_BehaviorServer::blackboard_set_entry<Transform3D>);
	ClassDB::bind_method(D_METHOD("blackboard_set_projection", "rid", "name", "value"), &_BehaviorServer::blackboard_set_entry<Projection>);
	ClassDB::bind_method(D_METHOD("blackboard_set_color", "rid", "name", "value"), &_BehaviorServer::blackboard_set_entry<Color>);
	...
	ClassDB::bind_method(D_METHOD("blackboard_set_dictionary", "rid", "name", "value"), &_BehaviorServer::blackboard_set_entry<Dictionary>);
	ClassDB::bind_method(D_METHOD("blackboard_set_array", "rid", "name", "value"), &_BehaviorServer::blackboard_set_entry<Array>);
	ClassDB::bind_method(D_METHOD("blackboard_set_packed_byte_array", "rid", "name", "value"), &_BehaviorServer::blackboard_set_entry<PackedByteArray>);
	ClassDB::bind_method(D_METHOD("blackboard_set_packed_int32_array", "rid", "name", "value"), &_BehaviorServer::blackboard_set_entry<PackedInt32Array>);
	ClassDB::bind_method(D_METHOD("blackboard_set_packed_int64_array", "rid", "name", "value"), &_BehaviorServer::blackboard_set_entry<PackedInt64Array>);
	ClassDB::bind_method(D_METHOD("blackboard_set_packed_float32_array", "rid", "name", "value"), &_BehaviorServer::blackboard_set_entry<PackedFloat32Array>);
	ClassDB::bind_method(D_METHOD("blackboard_set_packed_float64_array", "rid", "name", "value"), &_BehaviorServer::blackboard_set_entry<PackedFloat64Array>);
	ClassDB::bind_method(D_METHOD("blackboard_set_packed_string_array", "rid", "name", "value"), &_BehaviorServer::blackboard_set_entry<PackedStringArray>);
	ClassDB::bind_method(D_METHOD("blackboard_set_packed_vector2_array", "rid", "name", "value"), &_BehaviorServer::blackboard_set_entry<PackedVector2Array>);
	ClassDB::bind_method(D_METHOD("blackboard_set_packed_vector3_array", "rid", "name", "value"), &_BehaviorServer::blackboard_set_entry<PackedVector3Array>);
	ClassDB::bind_method(D_METHOD("blackboard_set_packed_color_array", "rid", "name", "value"), &_BehaviorServer::blackboard_set_entry<PackedColorArray>);
	ClassDB::bind_method(D_METHOD("blackboard_set_packed_vector4_array", "rid", "name", "value"), &_BehaviorServer::blackboard_set_entry<PackedVector4Array>);


	ClassDB::bind_method(D_METHOD("blackboard_erase_entry", "rid", "name"), &_BehaviorServer::blackboard_erase_entry);
	ClassDB::bind_method(D_METHOD("blackboard_has_entry", "rid", "name"), &_BehaviorServer::blackboard_has_entry);

	ClassDB::bind_method(D_METHOD("blackboard_export_entries", "rid"), &_BehaviorServer::blackboard_export_entries);
	ClassDB::bind_method(D_METHOD("blackboard_export_type_infos"), &_BehaviorServer::blackboard_export_type_infos);
...
bool _BehaviorServer::blackboard_set_parent(RID p_rid, RID p_parent) {
	return BehaviorServer::get_singleton()->blackboard_set_parent(p_rid, p_parent);
}

RID _BehaviorServer::blackboard_get_parent(RID p_rid) {
...
bool _BehaviorServer::blackboard_has_entry(RID p_rid, const StringName &p_name, bool p_check_parents) {
	return BehaviorServer::get_singleton()->blackboard_has_entry(p_rid, p_name);
}

Dictionary _BehaviorServer::blackboard_export_entries(RID p_rid) {
